...
export interface Series {
     ...
     * - Array of arrays of numbers. Supported when the [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) option is set to `"bubble"`, `"scatter"`,
     ...
     *
     * The `missingValues` option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to `"area"`, `"rangeArea"`, `"line"`, `"scatterLine"`,
     ...
     * The markers option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to `"area"`, `"rangeArea"`, `"line"`, `"scatter"`, `"scatterLine"`,
