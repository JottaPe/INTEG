...
import { Input, Component, NgZone, HostBinding, ElementRef, Output, EventEmitter, Optional, Inject, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
var StockChartComponent = (function (_super) {
    ...
    function StockChartComponent(configurationService, themeService, element, intl, ngZone, instanceEventService, changeDetector, rtl) {
        var _this = _super.call(this, configurationService, themeService, element, intl, ngZone, instanceEventService, changeDetector, rtl) || this;
