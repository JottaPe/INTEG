import { NgZone, ElementRef, EventEmitter, ChangeDetectorRef } from '@angular/core';
...
export declare class StockChartComponent extends ChartComponent {
    ...
    constructor(configurationService: ConfigurationService, themeService: ThemeService, element: ElementRef, intl: IntlService, ngZone: NgZone, instanceEventService: StockInstanceEventService, changeDetector: ChangeDetectorRef, rtl: boolean);
    /**
