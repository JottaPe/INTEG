import { NgZone, OnDestroy, ChangeDetectorRef, AfterViewChecked } from '@angular/core';
 ...
 * ```
 */
export declare class ChartComponent extends ChartComponentGenerated implements OnDestroy, AfterViewChecked {
    ...
    constructor(configurationService: ConfigurationService, themeService: ThemeService, element: ElementRef, intl: IntlService, ngZone: NgZone, instanceEventService: InstanceEventService, changeDetector: ChangeDetectorRef, rtl: boolean);
