...
var ChartComponent = (function (_super) {
    ...
    function ChartComponent(configurationService, themeService, element, intl, ngZone, instanceEventService, changeDetector, rtl) {
    ...
    ChartComponent.prototype.init = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            var element = _this.surfaceElement.nativeElement;
    ...
    ChartComponent.prototype.trigger = function (name, e) {
        ...
        if (emitter && emitter.emit && emitter.observers.length) {
    ...
    ChartComponent.prototype.setDonutCenter = function () {
        if (!this.instance || !this.options || !this.options.series) {
            delete this.donutCenterStyle;
            return;
        }
