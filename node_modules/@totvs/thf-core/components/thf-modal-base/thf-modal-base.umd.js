(function (global, factory) {
	...
	(factory((global['thf-modal-base'] = {}),global.core));
...
var ThfModalBaseComponent = (function () {
    ...
    ThfModalBaseComponent.propDecorators = {
        ...
        'setModalSize': [{ type: core.Input, args: ['t-size',] },],
        'setClickOut': [{ type: core.Input, args: ['t-click-out',] },],
        'setHideClose': [{ type: core.Input, args: ['t-hide-close',] },],
    };
    return ThfModalBaseComponent;
}());

exports.ThfModalBaseComponent = ThfModalBaseComponent;
