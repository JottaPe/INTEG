(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@totvs/thf-core/services/thf-dialog-base/thf-dialog.enum'), require('@totvs/thf-core/components/thf-modal-base'), require('@totvs/thf-core/services/thf-dialog-base/thf-dialog-base.service'), require('@totvs/thf-core/services/thf-notification-base/thf-notification-base.service'), require('@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-orientation.enum'), require('@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-base.component'), require('@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-type.enum'), require('@totvs/thf-core/interceptors/thf-http-interceptor-base')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@totvs/thf-core/services/thf-dialog-base/thf-dialog.enum', '@totvs/thf-core/components/thf-modal-base', '@totvs/thf-core/services/thf-dialog-base/thf-dialog-base.service', '@totvs/thf-core/services/thf-notification-base/thf-notification-base.service', '@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-orientation.enum', '@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-base.component', '@totvs/thf-core/services/thf-notification-base/thf-toaster-base/thf-toaster-type.enum', '@totvs/thf-core/interceptors/thf-http-interceptor-base'], factory) :
	(factory((global.interceptors = {}),global.core,global.thfDialog_enum,global.thfModalBase,global.thfDialogBase_service,global.thfNotificationBase_service,global.thfToasterOrientation_enum,global.thfToasterBase_component,global.thfToasterType_enum,global.thfHttpInterceptorBase));
}(this, (function (exports,core,thfDialog_enum,thfModalBase,thfDialogBase_service,thfNotificationBase_service,thfToasterOrientation_enum,thfToasterBase_component,thfToasterType_enum,thfHttpInterceptorBase) { 'use strict';
...
var ThfToasterComponent = (function (_super) {
    __extends$3(ThfToasterComponent, _super);
    /**
     * @param {?=} elementeRef
     */
...
var ThfNotificationService = (function (_super) {
    __extends$2(ThfNotificationService, _super);
    /**
     * @param {?} thfComponentInjector
     */
...
var ThfHttpInterceptorService = (function (_super) {
    __extends$4(ThfHttpInterceptorService, _super);
    /**
     * @param {?} notification
     * @param {?} dialog
     */
