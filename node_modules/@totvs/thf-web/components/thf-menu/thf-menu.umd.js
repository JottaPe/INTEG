(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/common'), require('@totvs/thf-core/components/thf-menu-base')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', '@angular/common', '@totvs/thf-core/components/thf-menu-base'], factory) :
	(factory((global['thf-menu'] = {}),global.core,global.router,global.common,global.thfMenuBase));
}(this, (function (exports,core,router,common,thfMenuBase) { 'use strict';
