(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@totvs/thf-core/components/thf-avatar-base'), require('@totvs/thf-core/components/thf-button-base'), require('@progress/kendo-angular-charts'), require('@totvs/thf-core/components/thf-chart-base'), require('@totvs/thf-core/components/thf-chart-base/thf-chart-colors.constant'), require('hammerjs'), require('@angular/router'), require('@angular/forms'), require('@angular/common/http'), require('@totvs/thf-core/utils/util'), require('@totvs/thf-core/components/thf-field-base'), require('@totvs/thf-core/utils'), require('@totvs/thf-core/components/thf-field-base/thf-upload-base/thf-upload-file'), require('@totvs/thf-core/components/thf-field-base/thf-upload-base/thf-upload-status.enum'), require('@progress/kendo-angular-grid'), require('@progress/kendo-data-query'), require('@totvs/thf-core/components/thf-grid-base/thf-grid-base.component'), require('@totvs/thf-core/components/thf-modal-base'), require('@totvs/thf-core/components/thf-menu-base'), require('@totvs/thf-core/components/thf-page-base'), require('@totvs/thf-core/components/thf-page-base/thf-page-base.component'), require('@totvs/thf-core/components/thf-tabs-base'), require('@angular/platform-browser'), require('@totvs/thf-core/components/thf-toolbar-base'), require('@totvs/thf-core/components/thf-widget-base')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@totvs/thf-core/components/thf-avatar-base', '@totvs/thf-core/components/thf-button-base', '@progress/kendo-angular-charts', '@totvs/thf-core/components/thf-chart-base', '@totvs/thf-core/components/thf-chart-base/thf-chart-colors.constant', 'hammerjs', '@angular/router', '@angular/forms', '@angular/common/http', '@totvs/thf-core/utils/util', '@totvs/thf-core/components/thf-field-base', '@totvs/thf-core/utils', '@totvs/thf-core/components/thf-field-base/thf-upload-base/thf-upload-file', '@totvs/thf-core/components/thf-field-base/thf-upload-base/thf-upload-status.enum', '@progress/kendo-angular-grid', '@progress/kendo-data-query', '@totvs/thf-core/components/thf-grid-base/thf-grid-base.component', '@totvs/thf-core/components/thf-modal-base', '@totvs/thf-core/components/thf-menu-base', '@totvs/thf-core/components/thf-page-base', '@totvs/thf-core/components/thf-page-base/thf-page-base.component', '@totvs/thf-core/components/thf-tabs-base', '@angular/platform-browser', '@totvs/thf-core/components/thf-toolbar-base', '@totvs/thf-core/components/thf-widget-base'], factory) :
	(factory((global.components = {}),global.core,global.common,global.thfAvatarBase,global.thfButtonBase,global.kendoAngularCharts,global.thfChartBase,global.thfChartColors_constant,null,global.router,global.forms,global.http,global.util,global.thfFieldBase,global.utils,global.thfUploadFile,global.thfUploadStatus_enum,global.kendoAngularGrid,global.kendoDataQuery,global.thfGridBase_component,global.thfModalBase,global.thfMenuBase,global.thfPageBase,global.thfPageBase_component,global.thfTabsBase,global.platformBrowser,global.thfToolbarBase,global.thfWidgetBase));
}(this, (function (exports,core,common,thfAvatarBase,thfButtonBase,kendoAngularCharts,thfChartBase,thfChartColors_constant,hammerjs,router,forms,http,util,thfFieldBase,utils,thfUploadFile,thfUploadStatus_enum,kendoAngularGrid,kendoDataQuery,thfGridBase_component,thfModalBase,thfMenuBase,thfPageBase,thfPageBase_component,thfTabsBase,platformBrowser,thfToolbarBase,thfWidgetBase) { 'use strict';
