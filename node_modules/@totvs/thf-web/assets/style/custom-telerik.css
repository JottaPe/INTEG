...
.k-scheduler-navigation .k-nav-next.k-state-hover, .k-scheduler-views li.k-state-hover, .k-scheduler-footer li.k-state-hover {
  ...
  background-image: linear-gradient(#097b98, #08738e);
}
...
.k-button.k-primary, .k-slider .k-draghandle, .k-switch-on .k-switch-handle {
  ...
  border-color: #0c9abe;
  background-image: linear-gradient(rgba(12, 112, 190, 0), rgba(12, 112, 190, 0.2));
}
...
.k-dialog-buttongroup .k-button.k-primary.k-state-hover, .k-slider .k-draghandle:hover, .k-switch-on:hover .k-switch-handle {
  ...
  border-color: #0c91be;
  background-image: linear-gradient(rgba(12, 104, 190, 0), rgba(12, 104, 190, 0.2));
}
...
.k-dialog-buttongroup .k-button.k-primary.k-state-active, .k-slider .k-draghandle:active, .k-slider .k-draghandle.k-pressed {
  background-color: #0c9abe;
  border-color: #0c9abe;
  background-image: linear-gradient(rgba(12, 112, 190, 0.2), rgba(12, 112, 190, 0));
}
...
.k-dirty {
  border-color: #c64840 #c64840 transparent transparent;
}
...
.k-widget.ng-invalid.ng-dirty .k-picker-wrap, .ng-invalid.ng-dirty.k-block .k-picker-wrap {
  color: #c64840;
  border-color: rgba(198, 72, 64, 0.5);
}
...
.k-popup .k-list .k-item > .k-group::before {
  border-color: #1d2426 #1d2426 transparent transparent;
}
...
.k-button.k-primary:focus, .k-button.k-primary.k-state-focused {
  box-shadow: 0 3px 4px 0 rgba(12, 154, 190, 0.4);
}
...
.k-dialog-buttongroup .k-button.k-primary.k-state-focused {
  box-shadow: inset 0 0 0 2px rgba(9, 123, 152, 0.3);
}
...
.k-grid td.k-state-selected {
  background-color: rgba(12, 154, 190, 0.25);
}
...
.k-grid .k-grouping-dropclue::before {
    border-color: #0c9abe transparent transparent;
}
...
.k-spreadsheet-selection {
  border-color: #0c9abe;
  background-color: rgba(12, 154, 190, 0.25);
  box-shadow: inset 0 0 0 1px #ffffff, 0 0 0 1px #0c9abe; 
}
...
.k-upload .k-file-error .k-file-extension-wrapper::before {
  border-color: transparent transparent #e8b5b2 #e8b5b2;
}

.k-upload .k-multiple-files-invalid-extension-wrapper::after {
  border-top-color: #e8b5b2;
  border-left-color: #e8b5b2;
}
...
.k-radio:checked + .k-radio-label::before {
  background-color: #0c9abe;
  box-shadow: 0 0 1px 0 #0c9abe inset;
}
...
.k-radio:focus:checked + .k-radio-label::before {
  box-shadow: 0 0 0 2px rgba(12, 154, 190, 0.3);
  border-color: #0c9abe;
}
...
.k-gantt-columns .k-nonwork-hour {
  background-color: rgba(29, 36, 38, 0.025);
}
...
.k-mediaplayer-titlebar {
  background-image: linear-gradient(rgba(29, 36, 38, 0.7), rgba(29, 36, 38, 0));
}
...
/*Remove o cálculo das margens superior e inferior ao editar uma linha do Thf Grid*/
.k-command-cell>.k-button, .k-edit-cell>.k-block, .k-edit-cell>.k-textbox, .k-edit-cell>.k-widget,
 .k-grid-edit-row td>.k-block, .k-grid-edit-row td>.k-textbox, .k-grid-edit-row td>.k-widget {
  margin-bottom: 0;
  margin-top: 0;
}